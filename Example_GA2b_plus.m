...
rng (3,'twister') % 2,13,32,51 good (initiallly 1)
Nper=12;
sigma=0.15;
r=0.04;
dt=1/Nper;
...
SkewPopolazione=skewness(X_Big_Rendimenti(Popolazione)/sigma,1);
KurtPopolazione=kurtosis(X_Big_Rendimenti(Popolazione)/sigma,1)-3;
w1=125;
w2=100;
w3=10;
w4=1;
...
disp(skewness(log(X_Big_CashAccount(Popolazione(:,1))),1))
disp(kurtosis(log(X_Big_CashAccount(Popolazione(:,1))),1))
